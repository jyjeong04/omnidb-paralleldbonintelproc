...
static inline void list_add_tail(struct request_handler *newp,
                                 struct request_handler *head) {
...
void kernel_enqueue(int size, int kid, cl_uint work_dim, const size_t *groups,
                    size_t *threads, cl_event *List, int *index,
