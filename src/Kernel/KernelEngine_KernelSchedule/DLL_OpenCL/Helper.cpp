...
void DLL_stopTimer(int timer) { DLL_sampleCommon->stopTimer(timer); }
...
void memset_int(cl_mem d_R, int rLen, int value, int numThreadPB, int numBlock,
  ...
  kernel_enqueue(rLen, 16, 1, &globalWorkingSetSize, &numThreadsPerBlock_x,
