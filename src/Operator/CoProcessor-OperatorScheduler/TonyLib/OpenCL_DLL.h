...
#define _OPENCL_DLL_H_
#include "../MyLib/common.h"
#include "../MianLib/cuCSSTree.h"
...
//#region Indexing Tree Types (IDirectoryNode, IDataNode from cuCSSTree.h)
typedef struct
{
	//IDataNode* data;
	cl_mem data;
...
extern "C" DLL_EXPORT void EngineStart(bool handShake,int _KernelSchedule);
extern "C" DLL_EXPORT  void EngineStop();
extern "C" DLL_EXPORT void restore();
#endif
